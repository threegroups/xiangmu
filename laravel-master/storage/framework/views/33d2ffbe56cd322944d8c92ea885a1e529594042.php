...
<div class="main">
    ...
    <div class='one_workflow yes_person'>
        <div class='workflow relave'>
            ...
            <span class='workflow1_1'><a href="/room/publish/basicinfo/850456679" class='a_after'>1</a></span>
            <span class='workflow1_2'><a href="/room/publish/detailinfo/850456679" class='a_after'>2</a></span>
            <span class='workflow1_3'><a href="/room/publish/imageinfo/850456679" class='a_after'>3</a></span>
    ...
    <div class="homes-con">
        ...
        <div class="homes clearfix">
            <form autocomplete="off" name="uploadFileForm" action="<?php echo e('basicinfo_four'); ?>" method="post" enctype="multipart/form-data">
                <input type="hidden" name="roomId" id="roomId" value="850456679" />
                <input type="hidden" name="flag" id="flag" value="" />
                <input type="hidden" name="cityId" id="cityId" value="12" />
                <input type="hidden" name="btnCanGo" id="btnCanGo" value="1" />
                <div class="homeSidebar">
                    <?php /*<a class="uploading" href="javaScript:;" style="position:relative;">*/ ?>
                    <input type="file" name="myfile[]" multiple />
                    <span id="spanButtonPlaceholder" class="uploading-btn"></span>
                    </a>
                    <p>按住shift或ctrl键可选择多张</p>
                    <p>拖动图片可以改变图片位置</p>
                    <p><em class="notice"></em>最少5张，最多50张</p>
                    <p><em class="notice"></em>单张照片不得超过5MB</p>
                    <p><em class="notice"></em>图片宽高比尽量接近4:3</p>
                </div>
                <div class="picture-box">
                    <div class="picture picture-big" style="min-height:270px;height:auto;">
                        <ul class="upload-default" id="logList" style="height:auto;">
                        </ul>
                    </div>
                    <div class="submit-wrap mt30">
                        <?php /*<a class="save" id="nextstep" href="javascript:void(0);">保存，下一步</a>*/ ?>
