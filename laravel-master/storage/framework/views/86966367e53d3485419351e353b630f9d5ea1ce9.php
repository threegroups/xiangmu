    ...
    <div class="main-l clearfloat" id='photo'>
        <div class="desWord">
            <h2><a href="#" rel="nofollow">天坛附近 浪漫温馨两居  10分钟到天坛</a>
                <?php /*<img src="http://staticnew.mayi.com/resourcesWeb/topic/2016/yzfy/images/level1.png" title='房源品质优良，值得信赖，推荐入住！' style="width:28px;height:33px;display:inline-block;vertical-align:middle;cursor:pointer">*/ ?>
                                ...
                                <ul class="piclist">
                                    ...
                                    <?php foreach($users as $k=>$v): ?>
                                        ...
                                        <li class="slideshow-item">
                                            <a href="#" rel="nofollow"><img src="http://localhost/laravel-master/public/public/images/<?php echo e($picture[0][$i]); ?>" alt="" width="860px" height="527px"/></a>
                                        </li>
                                        <?php }?>
                                    <?php endforeach; ?>
                                ...
                                <div class="picboxpic">
                                    <ul id="picsmall" class="picsmall clearfix" style="height: 2660px; top: -210px;">
                                        ...
                                        <?php foreach($users as $k=>$v): ?>
                                           <?php for($i=0;$i<count($picture[$k]);$i++){?>
                                               <li class="slideshow-item">
                                                   <a href="#" rel="nofollow"><img src="http://localhost/laravel-master/public/public/images/<?php echo e($picture[0][$i]); ?>" alt=""/></a>
                                               </li>
                                           <?php }?>
                                        <?php endforeach; ?>
                                    </ul>
        ...
        <div class='main-r_1'>
            <div class="order">
                ...
                <div class="pay">
                    <a id="goBookBtn"  href='<?php echo e(URL('order_list')); ?>'>立即预订</a>
                </div>
