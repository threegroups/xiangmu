...
" />
    ...
    <link rel="stylesheet" type="text/css" href="https://staticfiles.tujia.com/portalsite2/styles/css_common?v=405bfef" />
    ...
    <script type="text/javascript">
        function qqLogin() {
            window.location = "https://passport.tujia.com/PortalSite/QQLogin?srcUrl=http://www.tujia.com/beijing_gongyu/se0/?utm_source=baidu&utm_medium=cpc&kwid=35249576794&adid=10165915390&match=1&pos=cl2&utm_term=bc142ff4-e89a-4549-a4ca-25feae0057e7";
        }

        function sinaLogin() {
            window.location = "https://passport.tujia.com/PortalSite/SinaLogin?srcUrl=http://www.tujia.com/beijing_gongyu/se0/?utm_source=baidu&utm_medium=cpc&kwid=35249576794&adid=10165915390&match=1&pos=cl2&utm_term=bc142ff4-e89a-4549-a4ca-25feae0057e7";
        }
    </script>
...
<div id="J-ad-top" class="event-ad-fluid ">
    <a href="http://go.tujia.com/1525/?code=20160519nc1sytl" target="_blank" style="background:url(https://staticfiles.tujia.com/upload/specialOffer/day_160518/201605182122449913.jpg) no-repeat top center" >
    </a>
</div>
...
<div class="wrap-large" id="registerMainWrap">
    <div class="column-wrap">
        <div class="column-head">
            ...
            <a href="/PortalSite/EnterpriceRegister" class="">企业会员注册</a>

        </div>
        <div class="main-box">

            <div class="my-form-wrap">
                <form action="<?php echo e(URL('add_users')); ?>" autocomplete="off" id="registerForm" method="post"><input id="RefUrl" name="RefUrl" type="hidden" value="http://www.tujia.com/beijing_gongyu/se0/?utm_source=baidu&amp;utm_medium=cpc&amp;kwid=35249576794&amp;adid=10165915390&amp;match=1&amp;pos=cl2&amp;utm_term=bc142ff4-e89a-4549-a4ca-25feae0057e7" />
                    <input id="Source" name="Source" type="hidden" value="" />
                    <input id="EncryptMobile" name="EncryptMobile" type="hidden" value="" />
                    <div class="control-group">
                        <label class="controls-label" for="Mobile"><b>*</b>姓名：</label>
                        <div class="controls">
                    ...
                    <?php /*<div class="control-group" id="verifyImageContainer" >*/ ?>
                        <?php /*<label class="controls-label"><b>*</b>验证码：</label>*/ ?>
                        <?php /*<div class="controls">*/ ?>
                            <?php /*<input class="ipt-text-verify verification" data-message="请输入验证码" id="verifyCodePic" maxlength="4" name="verifyCodePic" type="text" value="" />*/ ?>
                            <?php /*<img src="/PortalSite/VerifyImageRegister" class="verify-image" id="VerifyImage" title="看不清？点击换一个" onclick="javascript:document.getElementById('VerifyImage').src='/PortalSite/VerifyImageRegister?r='+Math.random();return false;">*/ ?>
                        <?php /*</div>*/ ?>
                    <?php /*</div>*/ ?>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input id="btnGetVerifyCode" type="button" value="获取手机语音验证码" class="verify-code-btn"  onclick="bton_click()"/>
                    ...
                    <?php /*<div class="control-group">*/ ?>
                        <?php /*<label class="controls-label"><b>*</b>性别：</label>*/ ?>
                        <?php /*<div class="controls">*/ ?>
                            <?php /*<input type="radio" name="u_sex" value="男"/>男*/ ?>
                            <?php /*<input type="radio" name="u_sex" value="女"/>女*/ ?>
                        <?php /*</div>*/ ?>
                    <?php /*</div>*/ ?>
                    <?php /*<div class="control-group">*/ ?>
                        <?php /*<label class="controls-label">邀请码：</label>*/ ?>
                        <?php /*<div class="controls">*/ ?>
                            <?php /*<input class="ipt-text-verify" data-val="true" data-val-number="字段 FromId 必须是一个数字。" id="FromId" name="FromId" type="text" value="" />*/ ?>
                            <?php /*<span>使用好友给您的邀请码注册（选填）</span>*/ ?>
...
<script>
    ...
    function bton_click(){
            ...
            if(ajax.readyState==4 && ajax.status==200){
               alert(ajax.responseText);
                if(ajax.responseText==1){
                    alert('短信发送成功，验证码1分钟内有效,请注意查看手机短信。如果未收到短信，请在5分钟后重试！');
                }else{
        ...
        //链接服务器
        ajax.open('post','<?php echo e(URL('bton_click')); ?>',true);
...
<script type="text/javascript">
    var staticFileRoot = "https://staticfiles.tujia.com",
            ...
            TUJIA_CLIENTID = '6139d8a8-0fb9-4d75-8de6-fd823d24f4ab';
