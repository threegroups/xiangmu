...
<form action="<?php echo e(URL('order_show')); ?>"  method="post" style="position:relative">
        ...
        <div class='fl content_left'>
            <div class='cnt'>
                ...
                <div class='cnt1 clearfloat'>
                    ...
                    <div class='fl'>
                        ...
                        <!--预订套数-->
                        <?php /*<dl class='cnt1_dl clearfloat'>*/ ?>
                        <?php /*<dt class='fl'>预订套数</dt>*/ ?>
                        <?php /*<dd class='fl relave'>*/ ?>
                        <?php /*<div class='dianj2 fl'><i id="roomNum"></i></div>*/ ?>
                        <?php /*</dd>*/ ?>
                        <?php /*<b class='fl room_pice relave'>房费&nbsp;¥<strong id="showtotalprice"></strong><span class='tab_tan tab_tan1'></span>*/ ?>


                        <?php /*<!--房费弹出层-->*/ ?>
                        <?php /*<div class='asote price_par price_par1'  style='display:none;'>*/ ?>
                        <?php /*<p class="sanj sanj2 asote"></p>*/ ?>
                        <?php /*<table class='price price_fixed'>*/ ?>
                        <?php /*<tr class='relave'>*/ ?>
                        <?php /*<th width=92><div style='width:92px;'>日期</div></th>*/ ?>
                        <?php /*<th width=126><div style='width:126px;'>单价</div></th>*/ ?>
                        <?php /*<th width=43><div style='width:43px;'>数量</div></th>*/ ?>
                        <?php /*<th width=75 class='bon'><div style='width:75px;' >小计</div></th>*/ ?>
                        <?php /*</tr>*/ ?>
                        <?php /*</table>*/ ?>
                        <?php /*<div class='tab_par'>*/ ?>
                        <?php /*<table class='price' id='lefttable'>*/ ?>
                        <?php /*</table>*/ ?>
                        <?php /*</div>*/ ?>

                        <?php /*<div class='tfoot relave'>*/ ?>
                        <?php /*<div class='fr_fu absot'>共<b id='totlenight1'></b>晚&nbsp;合计¥<b id='totleprice1'></b></div>*/ ?>
                        <?php /*<ul class='fl_fu' id='llandlordrule'>*/ ?>
                        <?php /*<li>房东规定：</li>*/ ?>
                        <?php /*<li>·&nbsp;满7天9.5折，满30天9.0折 </li>*/ ?>
                        <?php /*</ul>*/ ?>
                        <?php /*</div>*/ ?>
                        ...
                        <dl class='cnt1_dl clearfloat'>
                            ...
                            <dd class='fl relave people_in'>
                                <?php /*<input type="hidden" id="maxguest" value="8"/>*/ ?>
                                <?php /*<input type="text" name="r_people_num" class='rens' tabindex="1" onkeyup="this.value=this.value.replace(/\D/g,'')" placeholder='最多入住8人' maxlength="2"/>*/ ?>
            ...
            <div class='cnt1 cnt2 clearfloat'>
                ...
                <div class="fl">
                    ...
                    <dl class='cnt1_dl clearfloat'>
                        <dt class='fl'>手机号</dt>
                        <dd class='fl'>
                            <?php /*<input type="text" placeholder="必填" class='import fl' tabindex="3" id="tenantmobile"  name="r_phone" value="5555"  autocomplete="off" />*/ ?>
                        ...
                        <div class='optional'>
                            ...
                            <table class="tab" id="add_person" style="margin-left:-142px;margin-bottom:0;width:830px;">
                                ...
                                <tr class="tr1 new_add">
                                    ...
                                    <?php /*<td class="ntd_div4">性别</td>*/ ?>
                                    <?php /*<td class="ntd_div5">出生日期</td>*/ ?>
                                ...
                                <tr class="inspersonDetail" id="source_1">
                                    ...
                                    <?php /*<td class="ntd_div4">*/ ?>
                                    <?php /*<p style="text-indent: 20px;"></p>*/ ?>
                                    <?php /*<select class="selectsex" id="person_sex1" autocomplete="off" style="display:none">>*/ ?>
                                    <?php /*<option value="" name="sexvalue">请选择</option>*/ ?>
                                    <?php /*<option value="男" name="sexvalue">男</option>*/ ?>
                                    <?php /*<option value="女" name="sexvalue">女</option>*/ ?>
                                    <?php /*</select>*/ ?>
                                    <?php /*</td>*/ ?>
                                    <?php /*<td class="ntd_div5" style="position:relative;">*/ ?>
                                    <?php /*<p class="birthdayp" style="text-indent: 20px;"></p>*/ ?>
                                    <?php /*<input type="text" class="J_Select birthday" autocomplete="off" id="person_birthday1" style="display:none" >*/ ?>
                                    <?php /*</td>*/ ?>
            ...
            <div class='cnt_foot' style="position:relative;">
                ...
                <div class='order_sub_parent'>
                    <?php /*<a   class='submit fl' onclick='submitOrder();'>提交订单</a>*/ ?>
