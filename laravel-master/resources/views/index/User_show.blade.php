            ...
            <li>
                <div class="showinfo">
                    <a href="javascript:menufrozen(851655010,'/tenant/851655010/orders','user')" target="_self">
                        ...
                        {{--<img  style="width:100px;height:100px;" src="http://localhost/laravel-master2/public/uploads/images/{{$user}}" height="10px" width="10px"/>--}}
    ...
    <div class="personalCenter clearfix">
        ...
        <div class="centerCon">
            ...
            <div class="accountMt clearfix">
                ...
                <div  class="MtList" style="display:block;">
                    <div class="avatar-box">
                        ...
                        <div class="avatar">
                            ...
                            <img  style="width:100px;height:100px;" src="http://localhost/laravel-master/public/uploads/images/{{$user}}" alt=""/>

                        </div>
                        {{--@endforeach--}}
                        <p>
                        <form method="POST" action="{{URL('up_tou')}}" enctype="multipart/form-data">
                    ...
                    <form action="{{URL('up_users')}}" method="post" onsubmit="return fun_all()">
                        <div class="tabCon">
                            <ul class="userInfo">
                            ...
                            <ul class="userInfo">
                                ...
                                {{--<li class="clearfix" id="addLi" >--}}
                                {{--<span class="infoTitle"  style="margin-left:-27px;width:107px;">备用手机号码： </span>--}}
                                ...
                                {{--<span style="margin-left:50px;padding:1px 10px;position:absolute;left:135px;">填写备用手机号码，以便特殊情况下可及时联系到您</span>--}}
                                {{--</li>--}}
                                {{--<li class="clearfix" id="otherLi"  style="display:none">--}}
                                {{--<span class="infoTitle"  style="margin-left:-27px;width:107px;">备用手机号码：</span>--}}
                                {{--<input style="color:#000;" class="personLargeInput" type="text" name="othermobile" id="othermobile" value=""  />--}}
                                {{--<a id="updateothermobile" class="checking"rel="nofollow" href="javascript:void(0)">[修改手机]</a>--}}
                ...
                <!-- 密码设置 START -->
                <div class="MtList">
                    <form action="{{URL('up_pwd')}}" method="post" onsubmit="return fun_all()">
