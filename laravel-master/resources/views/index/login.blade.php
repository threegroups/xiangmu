...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://staticfiles.tujia.com/portalsite2/styles/css_global?v=405bfef" />
    <script type="text/javascript" src="https://staticfiles.tujia.com/portalsite2/scripts/base/jquery.js?v=405bfef"></script>
    <script type="text/javascript" src="https://staticfiles.tujia.com/portalsite2/scripts/base/tujiacodecookie.js?v=405bfef"></script>
    <script type="text/javascript">
        var staticFileRoot = "https://staticfiles.tujia.com",
                ...
                TUJIA_CLIENTID = '4eb63cc5-341c-4caf-84a5-ecc57f468d49';
    ...
    <link rel="stylesheet" type="text/css" href="https://staticfiles.tujia.com/portalsite2/styles/im.css?v=405bfef" />
    <script type="text/javascript" src="https://staticfiles.tujia.com/portalsite2/scripts/base/jquery.js?v=405bfef"></script>

    <script type="text/javascript" src="https://staticfiles.tujia.com/portalsite2/scripts/js_account_head?v=405bfef"></script>



    <script type="text/javascript">
        function qqLogin() {
            window.location = "https://passport.tujia.com/PortalSite/QQLogin?srcUrl=http%3a%2f%2fwww.tujia.com%2fbeijing_gongyu%2fse0%2f%3futm_source%3dbaidu%26utm_medium%3dcpc%26kwid%3d35249576794%26adid%3d10165915390%26match%3d1%26pos%3dcl2%26utm_term%3dbc142ff4-e89a-4549-a4ca-25feae0057e7";
        }

        function sinaLogin() {
            window.location = "https://passport.tujia.com/PortalSite/SinaLogin?srcUrl=http%3a%2f%2fwww.tujia.com%2fbeijing_gongyu%2fse0%2f%3futm_source%3dbaidu%26utm_medium%3dcpc%26kwid%3d35249576794%26adid%3d10165915390%26match%3d1%26pos%3dcl2%26utm_term%3dbc142ff4-e89a-4549-a4ca-25feae0057e7";
        }

        function wechatLogin() {
            window.location = "https://passport.tujia.com/PortalSite/WeChatLogin?srcUrl=http%3a%2f%2fwww.tujia.com%2fbeijing_gongyu%2fse0%2f%3futm_source%3dbaidu%26utm_medium%3dcpc%26kwid%3d35249576794%26adid%3d10165915390%26match%3d1%26pos%3dcl2%26utm_term%3dbc142ff4-e89a-4549-a4ca-25feae0057e7";
        }
    </script>
...
<div class="hd-wrap-fluid ">
    <div class="m-hd">
        <div class="site-logo-cont">
            <a href="http://www.tujia.com/" target="_blank" title="途家网首页" class="site-logo" style="background:url(http://localhost/head.jpg);background-repeat:no-repeat">途家网</a>
...
<div class="wrap-large">
    <div class="banner-box">
        <a href="http://go.tujia.com/1525/?code=20160519nc1dly" target="_blank" rel="nofollow"><img src="https://staticfiles.tujia.com/upload/config/day_160519/201605190013112381.jpg" alt="" width="880" height="450" /></a>
    </div>
    <div class="sidebar-box">
        ...
        <div class="login-cont">
            <div class="lgoin-group" style=display:block id="usernamepwdLoginContainer">
                ...
                <form action="{{URL('yan_login')}}" method="post" id="userloginform">
                    <input type="hidden" name="accountIdentity" value="2" />
                    <input id="source" name="source" type="hidden" value="http://www.tujia.com/beijing_gongyu/se0/?utm_source=baidu&amp;utm_medium=cpc&amp;kwid=35249576794&amp;adid=10165915390&amp;match=1&amp;pos=cl2&amp;utm_term=bc142ff4-e89a-4549-a4ca-25feae0057e7" />

                    <div class="control-group">
                        <div class="controls">
                            <label for="username">
                                <input class="ipt-text" id="username" name="u_name" type="text" value="" autocomplete="off" />
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <label for="pwd">
                                <input class="ipt-text" id="pwd" name="u_pwd" type="password" value="" autocomplete="off" />
                    ...
                    <div class="control-group verifycode-group">
                        <div class="controls">
                            {{--<input class="ipt-text verify-text" data-message="请输入计算结果" id="verifycode" name="verifycode" type="text" value="" />--}}

                            {{--<span class="text-watermark" style="width:120px;">请输入计算结果</span>--}}
            ...
            <div class="lgoin-group" style=display:none id="smscodeLoginContainer">
                ...
                <form action="https://passport.tujia.com/PortalSite/SMSCodeLogin" method="post" id="smsCodeloginform">
                    ...
                    <div class="control-group verifycode-group" style="" id="verifyImageContainer">
                        <div class="controls">
                            <input class="ipt-text verify-text" data-message="请输入计算结果" id="verifyCodePic" name="verifyCodePic" type="text" value="" maxlength="4" />
                            <span class="text-watermark" style="width:120px">请输入计算结果</span>
                            <img id="smsverifyImage" alt="看不清楚，换一张" class="verify-image">
                            <a id="smsverifyImageLink" href="javascript:void(0)" class="change-rand">看不清，换一张</a>
                        </div>
                    </div>
                    <div class="control-group">
                        <div class="controls">
                            <label for="username">
                                ...
                                <span class="text-watermark" style="width:120px">动态密码</span>
                            </label>
...
<script type="text/javascript">
    var staticFileRoot = "https://staticfiles.tujia.com",
            ...
            houseId,
            ServerDomain = "tujia.com",
            TUJIA_CLIENTID = '8c210fff-1fe6-4799-b9f2-f3a55918c5bd';
...
<script type="text/javascript">
    ...
    $("#smsverifyImage,#smsverifyImageLink").click(function () {
        var verifyimagesrc = 'https://passport.tujia.com/PortalSite/VerifyImage?r=' + Math.random();
        ...
        if(this.id == "smsverifyImage"){
            ...
            $("#smsverifyImage").attr("src", verifyimagesrc);
        }
    ...
    $('#username,#pwd,#Mobile,#smsCode,#verifycode,#verifyCodePic').focus(function () {
        $(this).next().hide();
    }).blur(function () {
      //  alert($.trim($(this).val()))
        if ($.trim($(this).val()) == "") {
...
<script type="text/javascript" src="https://staticfiles.tujia.com/portalsite2/scripts/js_account_foot?v=405bfef"></script>
