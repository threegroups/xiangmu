...
<div class="main">
    ...
    <div class="homes-con">
        ...
        <div class="homes clearfix">
            <form autocomplete="off" name="uploadFileForm" action="{{'basicinfofour'}}" method="post" enctype="multipart/form-data">
                ...
                <div class="homeSidebar">
                    {{--<a class="uploading" href="javaScript:;" style="position:relative;">--}}
