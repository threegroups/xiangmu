...
<header class="Hui-header cl"> <a class="Hui-logo l" title="H-ui.admin v2.3" href="/">H-ui.admin</a> <a class="Hui-logo-m l" href="/" title="H-ui.admin">H-ui</a> <span class="Hui-subtitle l">V2.3</span>
	...
	<ul class="Hui-userbar">
		<li>超级管理员</li>
		<li class="dropDown dropDown_hover"><a href="#" class="dropDown_A">欢迎<?php echo $session->get('u_name');?>登陆<i class="Hui-iconfont">&#xe6d5;</i></a>
			<ul class="dropDown-menu radius box-shadow">
				<li><a href="index.php?r=login/member_show">个人信息</a></li>
				<li><a href="#">切换账户</a></li>
				<li><a href="index.php?r=login/exit">退出</a></li>
			</ul>
		</li>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-product">
			<dt><i class="Hui-iconfont">&#xe620;</i> 基础数据<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a _href="index.php?r=index/product_brand" href="javascript:void(0)">房源管理</a></li>
					<li><a _href="index.php?r=index/product_category" href="javascript:void(0)">房屋类型管理</a></li>
					<li><a _href="index.php?r=index/product_list" href="javascript:void(0)">配套设施管理</a></li>
				</ul>
			</dd>
		</dl>
		<!--<dl id="menu-page">
		...
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					...
					<li><a _href="index.php?r=index/feedback_list" href="javascript:void(0)">意见反馈</a></li>
				</ul>
			</dd>
		</dl>
		<!--<dl id="menu-order">
		...
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a _href="index.php?r=login/member_list" href="javascript:;">会员列表</a></li>
					<li><a _href="index.php?r=login/member_del" href="javascript:;">删除的会员</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a _href="index.php?r=index/admin_role" href="javascript:void(0)">角色管理</a></li>
					<li><a _href="index.php?r=index/admin_permission" href="javascript:void(0)">权限管理</a></li>
					<li><a _href="index.php?r=index/admin_list" href="javascript:void(0)">管理员列表</a></li>
				</ul>
			</dd>
		</dl>
		<!-- <dl id="menu-tongji">
...
<section class="Hui-article-box">
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="index.php?r=index/welcome"></iframe>
		</div>
	</div>
</section>
...
<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li><a _href="index.php?r=prodect/product_brand" href="javascript:void(0)">房源管理</a></li>
                    <li><a _href="index.php?r=prodect/product_category" href="javascript:void(0)">房屋类型管理</a></li>
                    <li><a _href="index.php?r=prodect/product_list" href="javascript:void(0)">配套设施管理</a></li>
                </ul>
            </dd>
        </dl>
        <!--<dl id="menu-page">
        ...
        <dl id="menu-comments">
            ...
            <dd>
                <ul>
                    <li><a _href="index.php?r=comment/comment_list" href="javascript:;">评论列表</a></li>
                    <li><a _href="index.php?r=comment/comment_list" href="javascript:void(0)">意见反馈</a></li>
                </ul>
            </dd>
        </dl>
        <!--<dl id="menu-order">
        ...
        <dl id="menu-member">
            ...
            <dd>
                <ul>
                    <li><a _href="index.php?r=list/lists" href="javascript:;">会员列表</a></li>
                    <li><a _href="index.php?r=list/member_del" href="javascript:;">删除的会员</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-admin">
