        ...
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <?php foreach($arr as $k=>$v){?>
                <tr class="text-c">
                    ...
                    <td class="td-manage"><a style="text-decoration:none" href="javascript:;" id="<?php echo $v['a_id']?>" onClick="member_huanyuan(this,'<?php echo $v['a_id']?>')" title="还原"><i class="Hui-iconfont">&#xe66b;</i></a> <a title="删除" id="<?php echo $v['a_id']?>" href="javascript:;" onclick="member_del(this,'<?php echo $v['a_id']?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
                </tr>
            <?php }?>
            </tbody>
        </table>
...
<script type="text/javascript">
    ...
    function member_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            $.ajax({
                type: "POST",
                url: "index.php?r=login/del_member2",
                data: "a_id="+id,
    ...
    function member_huanyuan(obj,id){
        layer.confirm('确认要还原吗？',function(index){
            $.ajax({
                type: "POST",
                url: "index.php?r=login/member_huanyuan",
                data: "a_id="+id,
                success: function(msg){
                    if(msg==1){
                        $(obj).parents("tr").remove();
